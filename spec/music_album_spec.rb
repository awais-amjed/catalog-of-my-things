...
describe MusicAlbum do
  context 'Given a publish_date' do
    it 'should create a Music Album with the provided Publish Date' do
      publish_date = DateHandler.from_string('2022-01-01')
      music_album = MusicAlbum.new(publish_date)

      expect(music_album.publish_date).to eql(publish_date)
  ...
  before :each do
    @music_album = MusicAlbum.new(DateHandler.from_string('2022-01-01'))
  end
